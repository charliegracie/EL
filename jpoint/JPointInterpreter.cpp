...
#include "JPointHelpers.hpp"

#include "JPointInterpreter.hpp"
...
JPointInterpreter::JPointInterpreter(TypeDictionary *types)
...
void JPointInterpreter::Setup() {
    ...
    JPointVMState *vmState = new JPointVMState(stack, stackRegister, localsArray, localsRegister, argsArray, argsRegister);
    setVMState(vmState);
...
//opcodes += NOP_LENGTH;
int64_t JPointInterpreter::doNop(RuntimeBuilder *rb, IlBuilder *b) {
    rb->DefaultFallthrough(b, b->ConstInt64(NOP_LENGTH));
    return 0;
}

//exit(0);
int64_t JPointInterpreter::doHalt(RuntimeBuilder *rb, IlBuilder *b) {
...
int64_t JPointInterpreter::doPushConstant(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
//PUSH(left + right);
//opcodes += ADD_LENGTH;
int64_t JPointInterpreter::doAdd(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
//return retVal;
int64_t JPointInterpreter::doReturn(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
int64_t JPointInterpreter::doPrintString(RuntimeBuilder *rb, IlBuilder *b) {
...
int64_t JPointInterpreter::doPrintInt64(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
//opcodes = target;
int64_t JPointInterpreter::doJMP(RuntimeBuilder *rb, IlBuilder *b) {
...
//   opcodes += JMPL_LENGTH;
//}
int64_t JPointInterpreter::doJMPL(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
// push(result)
int64_t JPointInterpreter::doCall(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
//PUSH(local);
//opcodes += 9;
int64_t JPointInterpreter::doPushLocal(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
int64_t JPointInterpreter::doPopLocal(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
//PUSH(left * right);
//opcodes += MUL_LENGTH;
int64_t JPointInterpreter::doMul(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
// }
// push(result)
int64_t JPointInterpreter::doCallWithJIT(RuntimeBuilder *rb, IlBuilder *b) {
    JPointVMState *state = static_cast<JPointVMState *>(rb->GetVMState(b));
...
void JPointInterpreter::registerHandlers(OMR::JitBuilder::RuntimeBuilder *rb) {
    //Register bytecode handlers
    rb->RegisterHandler((int32_t)Bytecodes::NOP, Bytecode::getBytecodeName(Bytecodes::NOP), (void *)&JPointInterpreter::doNop);
    rb->RegisterHandler((int32_t)Bytecodes::HALT, Bytecode::getBytecodeName(Bytecodes::HALT), (void *)&JPointInterpreter::doHalt);

    rb->RegisterHandler((int32_t)Bytecodes::PUSH_CONSTANT, Bytecode::getBytecodeName(Bytecodes::PUSH_CONSTANT), (void *)&JPointInterpreter::doPushConstant);
    rb->RegisterHandler((int32_t)Bytecodes::ADD, Bytecode::getBytecodeName(Bytecodes::ADD), (void *)&JPointInterpreter::doAdd);
    rb->RegisterHandler((int32_t)Bytecodes::RET, Bytecode::getBytecodeName(Bytecodes::RET), (void *)&JPointInterpreter::doReturn);

    rb->RegisterHandler((int32_t)Bytecodes::PRINT_STRING, Bytecode::getBytecodeName(Bytecodes::PRINT_STRING), (void *)&JPointInterpreter::doPrintString);
    rb->RegisterHandler((int32_t)Bytecodes::PRINT_INT64, Bytecode::getBytecodeName(Bytecodes::PRINT_INT64), (void *)&JPointInterpreter::doPrintInt64);

    rb->RegisterHandler((int32_t)Bytecodes::JMP, Bytecode::getBytecodeName(Bytecodes::JMP), (void *)&JPointInterpreter::doJMP);
    rb->RegisterHandler((int32_t)Bytecodes::JMPL, Bytecode::getBytecodeName(Bytecodes::JMPL), (void *)&JPointInterpreter::doJMPL);

    //rb->RegisterHandler((int32_t)Bytecodes::CALL, Bytecode::getBytecodeName(Bytecodes::CALL), (void *)&JPointInterpreter::doCall);

    rb->RegisterHandler((int32_t)Bytecodes::PUSH_LOCAL, Bytecode::getBytecodeName(Bytecodes::PUSH_LOCAL), (void *)&JPointInterpreter::doPushLocal);
    rb->RegisterHandler((int32_t)Bytecodes::POP_LOCAL, Bytecode::getBytecodeName(Bytecodes::POP_LOCAL), (void *)&JPointInterpreter::doPopLocal);
    rb->RegisterHandler((int32_t)Bytecodes::MUL, Bytecode::getBytecodeName(Bytecodes::MUL), (void *)&JPointInterpreter::doMul);

    rb->RegisterHandler((int32_t)Bytecodes::CALL, Bytecode::getBytecodeName(Bytecodes::CALL), (void *)&JPointInterpreter::doCallWithJIT);
}

void JPointInterpreter::defineFunctions(OMR::JitBuilder::RuntimeBuilder *rb, TypeDictionary *types) {
    IlType *VMType = types->LookupStruct("VM");
    IlType *pVMType = types->PointerTo(VMType);
    IlType *FunctionType = types->LookupStruct("Function");
    IlType *pFunctionType = types->PointerTo(FunctionType);
