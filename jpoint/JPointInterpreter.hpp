...
#ifndef JPOINT_INTERPRETER_INCL
#define JPOINT_INTERPRETER_INCL
...
typedef int64_t (JPointInterpreterType)(VM *vm, Function *function, int64_t *a);

class JPointInterpreter: public OMR::JitBuilder::InterpreterBuilder {
public:
    JPointInterpreter(OMR::JitBuilder::TypeDictionary *types);
    virtual void Setup();
...
class JPointVMState: public VirtualMachineState {
public:
    JPointVMState() :
        VirtualMachineState(),
            _stack(NULL),
    ...
    JPointVMState(VirtualMachineStack *stack,
    ...
    virtual VirtualMachineState *MakeCopy() {
        JPointVMState *newState = new JPointVMState();
    ...
    virtual void MergeInto(VirtualMachineState *other, IlBuilder *b) {
        JPointVMState *otherState = (JPointVMState *) other;
