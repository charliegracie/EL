...
JPointMethod::JPointMethod(TypeDictionary *types, VM *vm, Function *function)
   : CompiledMethodBuilder(types, (void *)function->opcodes, 1),
    ...
    JPointInterpreter::defineFunctions(this, types);
    ...
    JPointInterpreter::registerHandlers(this);
}

void JPointMethod::Setup() {
